...
**Test pyramid principle:** Unit tests are the suite foundation. Keep more unit tests than integration tests; integration tests complement unit coverage at real wiring and infrastructure boundaries, never replace it.
